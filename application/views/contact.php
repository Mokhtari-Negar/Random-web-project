...
<main class="main">
        ...
        <section class="winter-panel">
            <div class="container">
                ...
                <p>سلام به اسکارف گالری خوش آمدید.برای ارتباط و تماس با ما میتوانید به دانشکده ملی و مهارت شریعتی، دانشکده فنی، سایت 14، کلاس مبتنی بر وب با استاد نخعی مراجعه کنید . تیم پشتیبانی این سایت <b>فاطمه غفرانی و کیمیا باقری</b> هستیم و امیدواریم از عملکرد این سایت لازم را داشته باشید.</p>
            </div>
        </section>
    </main>
