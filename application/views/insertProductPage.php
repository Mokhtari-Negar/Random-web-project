...
<body>
    <div class="container">
        <h1>درج محصول</h1>
        <form action="<?php echo base_url() ?>index.php/AuthController/insertProduct" method="POST">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea id="description" name="description" rows="3" placeholder="توضیحات را وارد کنید"></textarea>
            </div>
            <div class="mb-3">
                <label for="productImage">آدرس تصویر محصول</label>
                <input type="text" id="productImage" name="imageName" placeholder="نام تصویر را وارد کنید">
            </div>
            <?php }  ?>
            <div class="btn-group">
